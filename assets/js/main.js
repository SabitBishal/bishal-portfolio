(function ($) {
    ...
    function rs_rtl_settings() {
        $('#bs-dir-toggler').on("change", function () {
            toggle_rtl();
        ...
        function rs_init_dir() {
            ...
            document.getElementById('bs-dir-toggler').checked = savedDir === 'rtl';
        }
    ...
    /* Event listeners  */
    $(".bs-theme-settings-open-btn").on("click", function () {
        $(".bs-theme-settings-area").toggleClass("settings-opened");
    });

    /* Initialize RTL settings if the element is present  */
    if ($("#bs-dir-toggler").length > 0) {
        rs_rtl_settings();
    }
    ...
    function rs_settings_append($x) {
        ...
        var settings_html = `<div class="bs-theme-settings-area">
		<div class="bs-theme-wrapper">
		<div class="bs-theme-header text-center">
		   <h4 class="bs-theme-header-title">Color Settings</h4>
		</div>

		<!-- THEME TOGGLER -->
		<div class="bs-theme-toggle mb-20 ${dark}">
		   <label class="bs-theme-toggle-main" for="bs-theme-toggler">
		   <span class="bs-theme-toggle-dark"><i class="fa-light fa-moon"></i> Dark </span>
				 <input type="checkbox" id="bs-theme-toggler">
				 <i class="bs-theme-toggle-slide"></i>
				 <span class="bs-theme-toggle-light active"><i class="fa-light fa-sun-bright"></i> Light</span>
		   </label>
		</div>

        <div class="bs-theme-header text-center">
		   <h4 class="bs-theme-header-title">Template Settings</h4>
		</div>

		<!--  RTL SETTINGS  mb-20 -->
		<div class="bs-theme-dir">
		   <label class="bs-theme-dir-main" for="bs-dir-toggler">
			  <span class="bs-theme-dir-rtl"> RTL</span>
				 <input type="checkbox" id="bs-dir-toggler">
				 <i class="bs-theme-dir-slide"></i>
			  <span class="bs-theme-dir-ltr active"> LTR</span>
		   </label>
		</div>

		<div class="bs-theme-settings">
		   <div class="bs-theme-settings-wrapper">
			  <div class="bs-theme-settings-open">
				 <button class="bs-theme-settings-open-btn">
					<span class="bs-theme-settings-gear">
					   <i class="fa-light fa-gear"></i>
					</span>
					<span class="bs-theme-settings-close">
...
========================================*/
    ...
    $(window).on("scroll", function () {
        if ($(this).scrollTop() > 250) {
            $("#header-sticky").addClass("bs-sticky");
        } else {
            $("#header-sticky").removeClass("bs-sticky");
        }
    });
    ...
    var PortfolioDetails = new Swiper('.portfolio_details_active_one', {
        ...
        navigation: {
            nextEl: ".bs-slider-button-next",
            prevEl: ".bs-slider-button-prev",
        },
        breakpoints: {
            '1200': {
                slidesPerView: 1,
    ...
    if ($('.portfolio-load-more').length > 0) {
        $('.grid').imagesLoaded(function () {
            ...
            $('.bs-portfolio-tab').on('click', 'button', function () {
                var filterValue = $(this).attr('data-filter');
                $grid.isotope({ filter: filterValue });
            });

            //for menu active class
            $('.bs-portfolio-tab button').on('click', function (event) {
            ...
            $(".bs-portfolio-tab").on('click', function () {
    ...
    // image scale active
    if ($('.bs-scale-item').length) {
        // Get all menu items
        const portfolio_items = document.querySelectorAll('.bs-scale-item');
    ...
    jQuery(document).ready(function ($) {
        $('.bs-button-wrapper .bs-btn').mouseenter(function () {
            $(this).find('.bs-icon').css('animation', 'btnHoverEffect 0.5s');
        });
        $('.bs-button-wrapper .bs-btn').mouseleave(function () {
            $(this).find('.bs-icon').css('animation', 'btnHoverEffectReverse 0.5s');
        });
    });

    $(document).ready(function () {
        // circle text slide
        if ($('.bs-text-circle').length) {
            $(".bs-text-circle").each(function () {
