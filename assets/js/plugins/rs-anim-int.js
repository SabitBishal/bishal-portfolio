(function ($) {
    ...
    function gsap_rs_split_text() {
        setTimeout(function () {
            var splitTextElements = $("body:not(.rtl) .bs-split-text-enable");
    ...
    function gsap_rs_custom_cursor() {
        ...
        if (cursorBall) {
            ...
            // Common Area
            $("a, button, input[type=submit], .slick-arrow, .slick-dots li button, .player-btn-comn, .revslider-initialised bs-arrow, .search_icons i, .bs-mnt, .bs-yrs, .tp-bullet, .rsoffwrap-close, .pricing-switcher-wrapper span").on("mouseenter", function (e) {
                gsap.to(cursorBall, { borderColor: "rgba(34, 34, 34, 0.05", scale: 1.7, opacity: 0.15, backgroundColor: "rgba(34, 34, 34, 0.2)" });
            });
            $("a, button, input[type=submit], .slick-arrow, .slick-dots li button, .player-btn-comn, .revslider-initialised bs-arrow, .search_icons i, .bs-mnt, .bs-yrs, .tp-bullet, .rsoffwrap-close, .pricing-switcher-wrapper span").on("mouseleave", function (e) {
    ...
    function gsap_rs_image_reveal() {
        ...
        document.querySelectorAll(".bs-image.scroll_reveal").forEach((wrapper) => {
            let image = wrapper.querySelector(".bs-image.scroll_reveal img");
